...
if GLASS_AVAILABLE then
    hl.config({
        ...
        kinetik_glass = {
            ...
            layer_namespaces = "garage-screenshot=pill,garage-launcher,garage-launcher-glass,garage-session-menu,garage-session-confirmation,garage-notification-center,garage-control-center,garage-monitor,garage-media,garage-ai-usage,garage-extension-ai-usage,garage-extension-microphone,garage-osd=pill",
